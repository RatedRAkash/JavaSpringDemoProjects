package com.example.demo_akash.jsonplaceholder;
...
public class JSONPlaceHolderConfiguration {
    ...
    //*** OpenFeign use korte Must "(DemoAkashApplication)Main_Application" ee giye "@EnableFeignClients" ei Annotation dewa lagbe ***
