...
/**
 * Class which represents a Time-based One-time Password as per RFC 6238. <p> Refer to {@link
 * TOTPBuilder} on how to generate a {@code TOTP}. </p>
 *
...
public final class TOTP {
    ...
    /**
     * Creates a new instance of a Time-based one time password. Use the static method to obtain a
     * {@link TOTPBuilder} instance and obtain a {@code TOTP} from that. Note that all parameters
     * are assumed to be valid since the {@link TOTPBuilder} is responsible for validation, and
     * creation of {@link TOTP}s.
     *
     * @param value the time-based one time password
     * @param time the time (in milliseconds)
     * @param hmacShaAlgorithm the {@link HmacShaAlgorithm}
     * @param digits the number of digits the generated TOTP value contains
    ...
    /**
     * Returns a new {@link TOTPBuilder} instance initialized with the specified {@code key}.
     *
    ...
    /**
     * Returns the time step size (in milliseconds) used to generate this {@code TOTP}.
     *
     * @return the time step size (in milliseconds) used to generate this {@code TOTP}.
     */
