...
/**
 * An immutable representation of an HMAC-Based One-Time Password as per RFC 4226. <p> Refer to
 * {@link HOTPBuilder} on how to generate a {@code HOTP}. </p>
 *
...
public final class HOTP {
    ...
    /**
     * Creates a new instance of an HMAC-based one time password. Use the static method to obtain a
     * {@link HOTPBuilder} instance and obtain a {@code HOTP} from that. Note that all parameters
     * are assumed to be valid since the {@link HOTPBuilder} is responsible for validation, and
     * creation of {@link HOTP}s.
     *
     * @param value the HMAC-based one time password value
     * @param digits the number of digits the generated HOTP value contains
    ...
    /**
     * Returns a new {@link HOTPBuilder} instance initialized with the specified {@code key}.
     *
